...
export default function Medical({ categoryId }) {
        ...
        post(route("medical.incident.create"), {
            ...
            onSuccess: () => {
                Swal.fire({
                    ...
                    text: "Your medical incident report has been successfully submitted.",
                    icon: "success",
            ...
            onError: () => {
                Swal.fire({
                    title: "Error",
                    text: "There was an error submitting your medical incident report. Please try again.",
                    icon: "error",
                    confirmButtonText: "OK"
                });
            }
    ...
    return (
        <div>
            <Head title="Add Medical Incident" />
