...
export default function Index({ auth, incidents=[], flash,term='' }) {
                ...
                if (searchTerm === '') {
                    ...
                    const filtered = incidents.data.filter((incident) => {
                        return (
                            ...
                            incident.category?.category_type.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    const handleSearch = (searchTerm) => {
        ...
        Inertia.get(route('incidents.index'), { term: searchTerm }, {
            preserveState: true,
            replace:true,
            preserveScroll: true,
        });
    ...
    return (
        <Authenticated user={auth.user} header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Incidents</h2>}>
                ...
                <table className="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3">Incident</th>
                    ...
                    <tbody>
                        {filteredIncidents.map((incident, index) => (
                            <tr key={index} className="border-b odd:bg-white even:bg-gray-50 dark:border-gray-700">
                                ...
                                {incident.category ? incident.category.category_type : 'No Category'}
                                </td>
